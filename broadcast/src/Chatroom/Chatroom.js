...
// const gatheringinfo = require('../../../models/Gatheringinfo');
// const roominfo = require('../../../models/Roominfo');


module.exports.ChatRoom = class ChatRoom extends EventEmitter {

    //Create a room with roomid
    ...
    // function for user enter chatroom 
    enter({
        userId,
        rtpCapabilities
    }) {
        console.log('[id:%s, userId:%s] entered', this._id, userId);
    ...
    // function for user exist chatroom
    exist(userId) {
